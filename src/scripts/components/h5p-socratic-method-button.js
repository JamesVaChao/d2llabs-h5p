...
import './h5p-socratic-method-button.scss';

/** Class representing the content */
export default class SocraticMethodButton {
  /**
   * @class
   ...
   */
  show() {
    this.button.classList.remove('h5p-socratic-method-display-none');
  }
   ...
   */
  hide() {
    this.button.classList.add('h5p-socratic-method-display-none');
  }
  ...
  enable() {
    ...
    this.button.classList.remove('h5p-socratic-method-button-disabled');
   ...
   */
  disable() {
    this.button.classList.add('h5p-socratic-method-button-disabled');
  ...
  activate() {
    ...
    if (this.params.type === 'toggle') {
      this.button.classList.add('h5p-socratic-method-button-active');
  ...
  deactivate() {
    ...
    if (this.params.type === 'toggle') {
      this.button.classList.remove('h5p-socratic-method-button-active');
