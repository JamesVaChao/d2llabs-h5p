...
class Util {
  ...
  static htmlDecode(input) {
    var DOMParser = new DOMParser().parseFromString(input, 'text/html');
    return DOMParser.documentElement ? DOMParser.documentElement.textContent : '';
  }
  ...
  /**
   * Format language tag (RFC 5646). Assuming "language-country". No validation.
